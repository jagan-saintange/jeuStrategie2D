...
class Game:
    ...
    def __init__(self, screen):
        ...
        """
        self.player_units = [Archer(0, 0, 10, 'player', 4, 3, 2),
                             Archer(1, 0, 10, 'player', 1, 5, 1)]

        self.enemy_units = [Archer(6, 6, 8, 'enemy', 1, 4, 4),
                            Archer(7, 6, 8, 'enemy',  2, 2, 1)]
        """
